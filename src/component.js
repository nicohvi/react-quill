...
var QuillComponent = createClass({
  ...
  shouldComponentUpdate: function(nextProps, nextState) {
    ...
    return R.any(function(prop) {
      // Note that `R.equals` compares deeply, making it safe to perform
      // non-immutable updates, at the cost of performance.
      return !R.equals(nextProps[prop], self.props[prop]);
    }, this.cleanProps);
  },
  ...
  isEqualValue: function(value, nextValue) {
    if (this.isDelta(value) && this.isDelta(nextValue)) {
      return R.equals(value.ops, nextValue.ops);
    } else {
      return R.equals(value, nextValue);
    }
  },
  ...
  onEditorChangeSelection: function(nextSelection, source, editor) {
    ...
    if (R.equals(nextSelection, currentSelection)) {
      return;
    }
